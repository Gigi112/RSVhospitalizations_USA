...
for(n in 1:n.state){
zeta[n] ~ dnorm(0,0.0001)
zeta_flu[n] ~ dnorm(0,0.0001)}

for(i in 1:n.group){
gamma_flu[i] ~ dnorm(0,0.0001)
gamma[i] ~ dnorm(0, 0.0001)
}

for(i in 1:n.age){
omega[i] ~ dnorm(0, tau2)
omega_flu[i] ~ dnorm(0,tau3)
}
